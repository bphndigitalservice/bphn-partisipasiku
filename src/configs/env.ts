...
export const STRAPI_REST_API_ENDPOINT =
  process.env.NEXT_PUBLIC_STRAPI_REST_API_ENDPOINT;
...
export const EMONEV_API_KEY = process.env.NEXT_PUBLIC_EMONEV_API_KEY;
export const EMONEV_API_ENDPOINT = process.env.NEXT_PUBLIC_EMONEV_API_ENDPOINT;
...
export const OG_URL = process.env.NEXT_PUBLIC_OG_URL;
